...
Menu不支持的通用属性：outline下的属性、shadow。
...
参数名	类型	必填	说明
value	Dimension | BorderRadiuses	是	
Menu边框圆角半径。
...
说明
从API version 9开始支持，从API version 10开始废弃，建议使用font代替。
